<template>
  <div class="text-center text-bold text-2xl mt-10 ml-5">"Visualizing, probing and manipulating matter at the atomic scale."</div>
  <div class="w-50 h-0.5 bg-[#111828] mx-auto rounded mt-2"></div>
  <div class="m-10">
    <img src="../assets/Lab.png" alt="STM Lab">
  </div>
  <div class="text-left text-bold text-2xl mt-10 ml-5">UHV-LT-STM</div>
